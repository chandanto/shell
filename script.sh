...
cd /tmp; wget https://raw.githubusercontent.com/chandanto/ppk/master/chandan_public_key_pem?token=ecadac539ed5992b6c03e6f7aafa1e6e891882fd; chmod 600 chandan_public_key_pem
